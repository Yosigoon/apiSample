...
public class DeliveryGatewayService {
    ...
    public List<String> selectInvoiceList(AddInvoiceListRequestParamVo addInvoiceListRequestParamVo) {
        return deliveryGatewayMapper.selectInvoiceList(addInvoiceListRequestParamVo);
    }
}
